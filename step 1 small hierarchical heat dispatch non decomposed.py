...
#        self.constraints.alpha_fix = {} # gradient of lagragian function / dP_gen[g,t]
#        
#        for t in time:
#            for h in heat_pump:
#                    self.constraints.alpha_fix[h,t] = m.addConstr(
#                        self.variables.alpha_HP[h,t],
#                        gb.GRB.EQUAL,
#                        100)
                        
#%% SOLVE THE MPEC 

heat_cost_0_hierarchical_0 = {}
Q_hierarchical_0 = {}
...
for W_max in W_range:                 
    ...
    heat_cost_0_hierarchical_0[W_max] = heat_dispatch.model.ObjVal

    
heat_cost_0_hierarchical = heat_cost_0_hierarchical_0
Q_hierarchical = Q_hierarchical_0
storage_energy_hierarchical = storage_energy_hierarchical_0
storage_charge_hierarchical = storage_charge_hierarchical_0
storage_discharge_hierarchical = storage_discharge_hierarchical_0
elec_maxprod_hierarchical = elec_maxprod_hierarchical_0
elec_minprod_hierarchical = elec_minprod_hierarchical_0