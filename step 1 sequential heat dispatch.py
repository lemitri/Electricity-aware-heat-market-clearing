...
#        for t in time:
#            alpha_heat_sequential[W_max,h,t] = alpha_scenario_kmeans['S_supply1',h,t]*(rho_heat[h] + rho_elec[h]*r_min[h])-np.random.normal(spot_price_hierarchical_average_0[W_max,t],spot_price_hierarchical_average_0[W_max,t]/5)*r_min[h]
#    
#    
#    for h in CHP_sorted['ex']:
#        for t in time:
#            p_estimate=np.random.normal(spot_price_hierarchical_average_0[W_max,t],spot_price_hierarchical_average_0[W_max,t]/5)
...
#    for h in heat_pump:  
#        for t in time:
#            alpha_heat_sequential[W_max,h,t] =  np.random.normal(spot_price_hierarchical_average_0[W_max,t],spot_price_hierarchical_average_0[W_max,t]/5)/COP[h]
#            
#    for h in heat_only:  
#        for t in time:
